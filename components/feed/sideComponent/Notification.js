...
const Notification = () => {
  const messages =[{message:'Hoping Groww will like my work',img:'/groww.png'},{message:'Tushar has started following you',img:"/dummyprofile.png"},{message:'5 person liked your photos',img:"/like.png"},{message:'Chirag comment on your photo',img:"/dummyprofile.png"},{message:'5 unseen messages',img:"/messenger.png"},{message:"5 people like your last reel",img:'/heart.png'}]
  return (
